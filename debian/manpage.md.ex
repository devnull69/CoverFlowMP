% coverflowmp(SECTION) | User Commands
%
% "March 12 2026"
...
coverflowmp - program to do something

# SYNOPSIS

**coverflowmp** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**coverflowmp** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **coverflowmp** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**coverflowmp** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    coverflowmp. See **foo.conf**(5) for further details.
...
**coverflowmp** provides some return codes, that can be used in scripts:
...
Thomas Theiner <devnull69@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Thomas Theiner
