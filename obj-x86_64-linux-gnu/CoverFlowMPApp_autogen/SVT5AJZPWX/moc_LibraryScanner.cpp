...
namespace {
struct qt_meta_stringdata_LibraryScanner_t {
    uint offsetsAndSizes[2];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_LibraryScanner_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_LibraryScanner_t qt_meta_stringdata_LibraryScanner = {
    {
        QT_MOC_LITERAL(0, 14)   // "LibraryScanner"
    },
    "LibraryScanner"
};
...
Q_CONSTINIT static const uint qt_meta_data_LibraryScanner[] = {
...
Q_CONSTINIT const QMetaObject LibraryScanner::staticMetaObject = { {
    ...
    qt_meta_stringdata_LibraryScanner.offsetsAndSizes,
    qt_meta_data_LibraryScanner,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_LibraryScanner_t,
        // Q_OBJECT / Q_GADGET
...
void *LibraryScanner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LibraryScanner.stringdata0))
